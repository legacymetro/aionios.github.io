...
function solopine_customizer_css() {
    ...
    <style type="text/css">
		...
		<?php if(get_theme_mod('sp_topbar_cart_icon')) : ?>.cart-contents:before {color:<?php echo get_theme_mod('sp_topbar_cart_icon') ?>;}<?php endif; ?>
		<?php if(get_theme_mod('sp_topbar_cart_counter')) : ?>.cart-contents .sp-count {background:<?php echo get_theme_mod('sp_topbar_cart_counter') ?>;}<?php endif; ?>
		<?php if(get_theme_mod('sp_topbar_cart_counter_text')) : ?>.cart-contents .sp-count {color:<?php echo get_theme_mod('sp_topbar_cart_counter_text') ?>;}<?php endif; ?>
		...
		<?php if(get_theme_mod( 'sp_sidebar_social_bg' )) : ?>.social-widget a i { color:<?php echo get_theme_mod( 'sp_sidebar_social_bg' ); ?>; }<?php endif; ?>
		<?php if(get_theme_mod( 'sp_sidebar_social_bg_hover' )) : ?>.social-widget a:hover > i { color:<?php echo get_theme_mod( 'sp_sidebar_social_bg_hover' ); ?>; }<?php endif; ?>
		
		a, .social-widget a:hover > i, .woocommerce .star-rating { color:<?php echo get_theme_mod( 'sp_color_accent' ); ?>; }
		...
		<?php if(get_theme_mod( 'sp_color_footer_bg' )) : ?>#footer { background:<?php echo get_theme_mod('sp_color_footer_bg'); ?>; }<?php endif; ?>
		<?php if(get_theme_mod( 'sp_color_footer_text' )) : ?>#footer .copyright { color:<?php echo get_theme_mod('sp_color_footer_text'); ?>; }<?php endif; ?>
