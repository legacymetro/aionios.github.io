<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="post-header">
		...
		<span class="date"><span class="date updated published"><?php the_time( get_option('date_format') ); ?></span></span>
		<?php endif; ?>
	...
	<div class="post-meta">
		...
		<div class="meta-share">
			...
			<?php if(!get_theme_mod('sp_post_share_facebook')) : ?><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=<?php the_permalink(); ?>"><i class="fa fa-facebook"></i></a><?php endif; ?>
			<?php if(!get_theme_mod('sp_post_share_twitter')) : ?><a target="_blank" href="https://twitter.com/intent/tweet?text=Check%20out%20this%20article:%20<?php print solopine_social_title( get_the_title() ); ?>&url=<?php echo urlencode(the_permalink()); ?>"><i class="fa fa-twitter"></i></a><?php endif; ?>
			<?php if(!get_theme_mod('sp_post_share_pinterest')) : ?>
			...
			<?php endif; ?>
			<?php if(!get_theme_mod('sp_post_share_google')) : ?><a target="_blank" href="https://plus.google.com/share?url=<?php the_permalink(); ?>"><i class="fa fa-google-plus"></i></a><?php endif; ?>
			<?php if(!get_theme_mod('sp_post_share_linkedin')) : ?><a target="_blank" href="https://www.linkedin.com/shareArticle?mini=true&url=<?php echo urlencode(the_permalink()); ?>&title=<?php print solopine_social_title( get_the_title() ); ?>&summary=&source="><i class="fa fa-linkedin"></i></a><?php endif; ?>
		</div>
		<?php endif; ?>
