	...
	<div id="top-bar">
		...
		<div class="container">
			...
			<div id="top-social" <?php if(get_theme_mod('sp_topbar_search_check')) : ?>class="nosearch"<?php endif; ?>>
				...
				<?php if(!get_theme_mod('sp_woo_cart_icon')) : ?>
				<div id="sp-shopping-cart">
				<?php $count = WC()->cart->cart_contents_count; ?>
					<a class="cart-contents" href="<?php echo WC()->cart->get_cart_url(); ?>" title="<?php _e( 'View your shopping cart', 'hemlock' ); ?>"><?php if ( $count >= 0 ) echo '<span class="sp-count">' . $count . '</span>'; ?></a>
				</div>
				<?php endif; ?>
				<?php endif; ?>
